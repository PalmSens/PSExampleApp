...
using PSExampleApp.Core.Resolvers;
using System;
    ...
    public class ShareService : IShareService
    {
        ...
        public void CreatePdfFile(HeavyMetalMeasurement measurement, string filepath)
        {
            ...
            try
            {
                ...
                gfx.DrawString("PS Example App Measurement report", titleFont, XBrushes.Black, new XRect(0, 20, page.Width, page.Height), XStringFormats.TopCenter);
